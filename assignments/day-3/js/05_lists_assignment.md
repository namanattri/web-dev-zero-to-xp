...
Complete the following coding challenges to practice working with arrays and multi-dimensional arrays in JavaScript/TypeScript.

---

## Question 1: Array Statistics
Given an array of numbers, find the sum, average, maximum, and minimum.

**Sample Input:**
```typescript
const numbers: number[] = [12, 45, 23, 67, 34, 89, 15];
```
...
**Sample Input:**
```typescript
const items: number[] = [1, 2, 3, 2, 4, 2, 5];
const removeValue: number = 2;
```

**Sample Output:**
```
Original array: [1, 2, 3, 2, 4, 2, 5]
...
## Question 10: Array Map/Filter - Squares
Create a new array containing squares of even numbers from the original array.
