# Assignment 11: Python References

Complete the following coding challenges to practice understanding references, mutability, and memory management in Python.

---

## Question 1: Variable Reference Demo
Demonstrate how variables reference objects in Python.
...
## Question 3: List Copy Methods
Demonstrate different ways to copy a list and their effects.
...
Demonstrate the difference with nested lists.
...
## Question 7: Mutable Default Argument Trap
Demonstrate the common mistake with mutable default arguments.
...
Call 2: [1, 2]
Call 3: [1, 2, 3]
Unexpected! Same list reused!

=== CORRECT WAY ===
Call 1: [1]
Call 2: [2]
Call 3: [3]
Each call gets new list!
```
